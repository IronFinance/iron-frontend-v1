...
const RedeemInfoBox: React.FC = () => {
  return (
    <InfoBox
      width="640px"
      boxKey="info-redeem"
      content="Redeeming an amount of IRON tokens at a specific Effective Collateral Ratio will produce a portion of collateral tokens and a portion of TITAN tokens."
